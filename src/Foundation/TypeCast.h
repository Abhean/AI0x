...
Foundation::STypeCastEntry TYPECAST_##SOURCE_NAMESPACE##_##SOURCE_TYPE##_2_##TARGET_NAMESPACE##_##TARGET_TYPE(#SOURCE_NAMESPACE"::"#SOURCE_TYPE, #TARGET_NAMESPACE"::"#TARGET_TYPE, &Foundation::TypeCast<SOURCE_NAMESPACE::SOURCE_TYPE, TARGET_NAMESPACE::TARGET_TYPE>::Apply);

#define IMPLEMENT_TYPE_CAST_NST_NSPT(SOURCE_NAMESPACE, SOURCE_TYPE, TARGET_NAMESPACE, TARGET_TYPE) \
Foundation::STypeCastEntry TYPECAST_##SOURCE_NAMESPACE##_##SOURCE_TYPE##_2_##TARGET_NAMESPACE##_##TARGET_TYPE##_##PTR(#SOURCE_NAMESPACE"::"#SOURCE_TYPE, #TARGET_NAMESPACE"::"#TARGET_TYPE"*", &Foundation::TypeCast<SOURCE_NAMESPACE::SOURCE_TYPE, TARGET_NAMESPACE::TARGET_TYPE*>::Apply);

#define IMPLEMENT_TYPE_CAST_NST_PT(SOURCE_NAMESPACE, SOURCE_TYPE, TARGET_TYPE) \
Foundation::STypeCastEntry TYPECAST_##SOURCE_NAMESPACE##_##SOURCE_TYPE##_2_##TARGET_TYPE(#SOURCE_NAMESPACE"::"#SOURCE_TYPE, #TARGET_TYPE"*", &Foundation::TypeCast<SOURCE_NAMESPACE::SOURCE_TYPE, TARGET_TYPE*>::Apply);

#define IMPLEMENT_TYPE_CAST_PT_NST(SOURCE_TYPE, TARGET_NAMESPACE, TARGET_TYPE) \
Foundation::STypeCastEntry TYPECAST_##SOURCE_TYPE##_2_##TARGET_NAMESPACE##_##TARGET_TYPE##_PTR(#SOURCE_TYPE"*", #TARGET_NAMESPACE"::"#TARGET_TYPE, &Foundation::TypeCast<SOURCE_TYPE*, TARGET_NAMESPACE::TARGET_TYPE>::Apply);

#define IMPLEMENT_TYPE_CAST_NSPT_NST(SOURCE_NAMESPACE, SOURCE_TYPE, TARGET_NAMESPACE, TARGET_TYPE) \
Foundation::STypeCastEntry TYPECAST_##SOURCE_NAMESPACE##_##SOURCE_TYPE##_PTR_2_##TARGET_NAMESPACE##_##TARGET_TYPE(#SOURCE_NAMESPACE"::"#SOURCE_TYPE"*", #TARGET_NAMESPACE"::"#TARGET_TYPE, &Foundation::TypeCast<SOURCE_NAMESPACE::SOURCE_TYPE*, TARGET_NAMESPACE::TARGET_TYPE>::Apply);
...
Foundation::STypeCastEntry TYPECAST__##SOURCE_TYPE##_2__##TARGET_TYPE(#SOURCE_TYPE, #TARGET_TYPE, &Foundation::TypeCast<SOURCE_TYPE, TARGET_TYPE>::Apply);
